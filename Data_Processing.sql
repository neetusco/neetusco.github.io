...
GENERATED ALWAYS AS (ROUND((JULIANDAY(ended_at) - JULIANDAY(started_at))*3600))
...
## Adding column start_time

ALTER TABLE Combined_2023
ADD COLUMN ride_start_time
GENERATED ALWAYS AS (strftime('%H:%M', started_at))
